...
export default {
  ...
  // Color
  brandPrimary: Colors.defaultAppColor,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  activeTab: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  sTabBarActiveTextColor: Colors.defaultAppColor,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  ...
  // topTabBarActiveTextColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
  // topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  // topTabBarActiveBorderColor: platform === PLATFORM.IOS ? Colors.defaultAppColor : '#fff',
